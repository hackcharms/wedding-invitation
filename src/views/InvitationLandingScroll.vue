...
import IntroScrollSequence from "@/components/wedding/IntroScrollSequence.vue";
...
<template>
  <div
    class="min-h-screen bg-luxury-dark text-luxury-cream overflow-x-hidden relative"
  >
